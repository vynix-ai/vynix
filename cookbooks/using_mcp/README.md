# Using MCP (Model Context Protocol) with vynix

This cookbook demonstrates how to integrate MCP servers with vynix for dynamic
...
- [vynix Documentation](https://github.com/lion-agi/lionagi)

## License

This cookbook is part of the vynix project and follows the same Apache 2.0
license.

...
- **vynix delivers 2× faster cold-start performance** than the next-best
...
- **Cold Composite Performance** (geomean of medians; excludes imports): vynix
  **153.6 ms** vs LangGraph **340.9 ms** → **LangGraph is 121.9% slower**
  (**vynix is 2.2× faster**)
- **Memory Efficiency**: vynix **26.0 MB RSS** vs LangGraph 56.4 MB (**54%
  lower**)
- **Consistency**: First-place performance in **4/4 cold-start categories**
- **Orchestrator Setup**: vynix **170.1 ms** vs LangGraph 329.0 ms (**93.4%
  faster**)
...
- Conservative composite (excluding `data_processing`): vynix **176.0 ms** vs LangGraph
**342.4 ms** → **LangGraph is 94.5% slower** (**vynix is 1.9× faster**).
...
| -------------- | ----------- | -------- | ----------- | -------- | ------- |
| **vynix**    | 170.1       | 177.4    | 165.5-207.6 | 26.9     | —       |
...
| Framework      | Median (ms) | P95 (ms) | Range       | RSS (MB) | vs Best |
| -------------- | ----------- | -------- | ----------- | -------- | ------- |
| **vynix**    | 182.7       | 222.7    | 176.8-224.6 | 28.2     | —       |
...
| Framework      | Median (ms) | P95 (ms) | Range       | RSS (MB) | vs Best |
| -------------- | ----------- | -------- | ----------- | -------- | ------- |
| **vynix**    | 175.5       | 186.0    | 165.7-202.5 | 27.4     | —       |
...
| Framework      | Median (ms) | P95 (ms) | Range       | RSS (MB) | vs Best  |
| -------------- | ----------- | -------- | ----------- | -------- | -------- |
| **vynix**    | 102.1       | 112.9    | 99.2-122.8  | 21.7     | —        |
...
- **vynix**: 26.0 MB average RSS (22.6 MB USS) — **most memory efficient**
- **LangGraph**: 56.4 MB average RSS (**+116.9% vs vynix**)
...
| --------------------- | ----------- | -------------------------------------- |
| Serverless/Lambda     | vynix     | Fastest cold start (153.6ms composite) |
| Memory-Limited        | vynix     | Lowest footprint (26.0MB)              |
...
_Last updated: October 15, 2025 • vynix v0.18.1 • Python 3.10.15_ _Benchmark

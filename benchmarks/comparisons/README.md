...
Key findings:
- Core object creation: vynix 158ms, LangGraph 266ms, AutoGen 898ms
- Practical setup time: vynix 276ms, AutoGen 904ms, LangChain 1925ms
- Memory usage: vynix 27-50MB, LangGraph 45-49MB, AutoGen 125-145MB
- Import performance: LangGraph 0.1ms, vynix 35ms, AutoGen 882ms
...
|-----------|-------------|----------|-------------|----------|
| **vynix** | 158.0 | 1.0x | 26.6 | AI model abstraction |
...
| **vynix** | 280.8 | 1.0x | 44.0 | Builder + Session |
...
**Import Performance**
- LangGraph: 0.1ms
- vynix and LangChain: 35-59ms
- LlamaIndex: 535ms
- AutoGen: 882ms

**Object Creation Patterns**
- vynix: 158ms for core iModel object
...
|-----------|-----------------|-----------|----------------|
| **vynix** | Multi-model orchestration | Consistent performance, low memory | Moderate import time |
...
- **vynix**: Low setup times (158-276ms) with moderate memory usage (27-50MB)
...
*Last updated: September 2025 • vynix v1.0 • [Benchmark methodology](./benchmark_professional.py)*

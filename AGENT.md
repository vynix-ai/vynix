...
Practical guide for all coding agents working in the vynix repository.

## Mission

vynix is an async-first SDK for building and orchestrating AI workflows with structured operations, tool calling, and graph-style execution.

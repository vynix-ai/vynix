"""
Centralized Mock Factory for vynix Testing
...
Usage Examples:
    ...
    branch = vynixMockFactory.create_mocked_branch(response="custom response")
...
class vynixMockFactory:
    """Centralized factory for creating standardized mocks in vynix tests."""
    ...
    def create_mocked_branch(
        ...
        mock_chat_model = vynixMockFactory.create_mocked_imodel(
    ...
    def create_mocked_imodel(
        ...
        if responses:
            ...
            async def _sequence_invoke(**kwargs):
                ...
                return vynixMockFactory.create_api_calling_mock(

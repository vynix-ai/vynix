...
All tests avoid real API calls by using vynixMockFactory or
...
class TestErrorHandling:
    ...
    def test_error_response_mock_factory(self):
        """vynixMockFactory can create error response mocks for testing."""
        mock = vynixMockFactory.create_error_response_mock(
    ...
    async def test_sequential_imodel_responses(self):
        ...
        model = vynixMockFactory.create_mocked_imodel(

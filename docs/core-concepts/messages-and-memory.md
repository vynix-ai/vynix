...
vynix manages conversation state through a structured message system. Understanding which operations add to history and how messages are organized is essential for building reliable workflows.

## The Key Distinction: chat() vs communicate()

The most important thing to understand about vynix's memory model:

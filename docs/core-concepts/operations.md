...
Operations are the fundamental building blocks of vynix workflows. They define specific tasks that Branches execute, control execution order through dependencies, and enable complex orchestration patterns.
...
vynix provides three core operation types, each optimized for different use cases:

...
This tutorial walks you through a **basic “auto-coding” scenario** with vynix:
...
1. Prerequisites
---------------------
- **vynix** library installed (which includes ``types``, ``Session``, ``Branch``, etc.).
...
With vynix, you can scale this approach to more complex tasks (RAG with external docs,

...
!!! tip "Recommended: Using uv"
    vynix works best with [uv](https://docs.astral.sh/uv/) for fast, reliable dependency management:
...
!!! warning "API Key Required"
    vynix needs an LLM provider API key to work. Choose one:

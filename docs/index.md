...
<strong>vynix is evolving:</strong> From a collection of operations to a coordination engine where you define operations and vynix orchestrates them - agentic or otherwise.
</div>
...
# Step 2: vynix orchestrates your workflow
...
# The key: You define the workflow. vynix provides reliable orchestration.
```

## 🎯 What vynix Does Well
...
!!! tip "Choose Your Starting Point"
    **New to vynix?** → Follow the path below step-by-step  
...
- [Why vynix?](thinking-in-lionagi/why-lionagi.md) - Technical differences that matter
- [Thinking in vynix](thinking-in-lionagi/) - Learn the mental model

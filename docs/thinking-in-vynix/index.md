...
!!! info "You're in Step 2 of the Learning Path"
    Coming from the [Quick Start](../quickstart/)? Great! Now let's understand the mental model that makes vynix different from other frameworks.

The key to successfully using vynix is understanding its fundamental paradigm shift: **from conversations to graphs, from sequential to parallel, from rigid to flexible.**

## Core Ideas

### [Why vynix?](why-lionagi.md)
...
**vynix way**: Agents execute operations
...
**vynix way**: Dynamic capabilities
...
!!! success "Ready for Core Concepts?"
    Now that you understand vynix's mental model, dive into the practical mechanics:

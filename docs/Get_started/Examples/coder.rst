RAG Assisted Auto Developer -- with vynix, LlamaIndex, AutoGen and OAI Code Interpreter
=================================================
...
.. tip::
   ...
   created two runnable classes based on two existing functions in vynix,

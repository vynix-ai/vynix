...
vynix has a helper function  ``m_call`` (map call) to streamline the execution of element-wise functions. Rather than
...
Now, with all the necessary information in hand, let's organize it into contexts. vynix provides a utility function

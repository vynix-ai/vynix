...
Use LlamaIndex for RAG (Retrieval-Augmented Generation) within vynix workflows.

## Why LlamaIndex + vynix?
...
2. **Superior Orchestration**: vynix handles parallel execution, dependencies, error handling
...
LlamaIndex provides the RAG capabilities, vynix provides the orchestration intelligence.
...
Use LlamaIndex for RAG (Retrieval-Augmented Generation) within vynix
workflows.

## Why LlamaIndex + vynix?

**LlamaIndex**: Best-in-class RAG capabilities, document indexing, retrieval
**vynix**: Superior orchestration, parallel execution, multi-agent
coordination
...
LlamaIndex provides the RAG capabilities, vynix provides the orchestration
intelligence.

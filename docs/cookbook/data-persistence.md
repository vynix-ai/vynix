...
from lionagi.adapters.async_postgres_adapter import vynixAsyncPostgresAdapter
...
Student.register_async_adapter(vynixAsyncPostgresAdapter)
```
...
ConversationNode.register_async_adapter(vynixAsyncPostgresAdapter)
...
SupabaseNode.register_async_adapter(vynixAsyncPostgresAdapter)

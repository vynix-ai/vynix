...
Guidance specifically for AI agents working with vynix.
...
- **[Claude Code Usage](claude-code-usage.md)** - vynix in Claude Code environment
- **[Self-Improvement](self-improvement.md)** - Learn and adapt your approaches

## Key Concepts for AI Agents

**Think in Graphs**: vynix uses dependency graphs, not sequential chains

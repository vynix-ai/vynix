...
.. module:: lionagi.protocols._concepts
   :synopsis: Defines fundamental abstract base classes that shape vynix's roles and capabilities.

Overview
--------
These classes outline the base “roles” in vynix—such as observation, management, 
...
.. class:: Relational
   ...
   Represents a **graph-connectable** object. In vynix, classes implementing ``Relational`` 
...
.. class:: Observable
   ...
   Many core vynix classes inherit from ``Observable`` to ensure they can be referenced, 

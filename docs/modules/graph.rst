...
Overview
--------
This documentation covers the **graph** structures in vynix, comprising 
...
.. class:: Edge(Element)
   ...
   **Inherits from**: :class:`~lionagi.protocols.generic.element.Element`
   ...
   vynix graph. An optional :attr:`condition` determines if traversal is 
...
.. class:: Node(Element, Relational)
   ...
   **Inherits from**: :class:`~lionagi.protocols.generic.element.Element`, :class:`~lionagi.protocols._concepts.Relational`
   ...
   vynix adapter system, enabling easy import/export to JSON, pandas 
   Series, etc.

...
from a shared base (:class:`RoledMessage`), itself extending vynix’s
...
.. class:: ActionRequest
   ...
   vynix’s :class:`ActionManager` or from user input desiring a function call.
...
With these message classes, vynix can handle:

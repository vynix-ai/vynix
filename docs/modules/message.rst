...
Overview
--------
This subsystem handles **structured messages** in vynix, enabling:
...
.. module:: lionagi.protocols.messages.action_request
    ...
    Defines the ActionRequest class, a specific RoledMessage for requesting a function or action call within vynix. It is typically accompanied by arguments and can later be answered by an ActionResponse.

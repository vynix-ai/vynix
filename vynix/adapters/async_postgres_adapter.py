"""
Clean vynix async PostgreSQL adapter for integration into lionagi core.
...
class vynixAsyncPostgresAdapter(AsyncPostgresAdapter[T]):
    """
    ...
    2. vynix float timestamp serialization (created_at as float → datetime)
    3. Datetime objects in JSON content (datetime → ISO strings)
    4. Automatic metadata field mapping via vynixPostgresAdapter
    ...
    async def to_obj(
        ...
        **kw,
        ...
        2. vynix data serialization fixes

"""
Simplified vynix async PostgreSQL adapter for pydapter v1.0.4+
...
def create_lionagi_async_postgres_adapter() -> type[AsyncAdapter]:
    ...
    return vynixAsyncPostgresAdapter


vynixAsyncPostgresAdapter = create_lionagi_async_postgres_adapter()

__all__ = ("vynixAsyncPostgresAdapter",)

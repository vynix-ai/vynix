...
from ._types import T, UndefinedType, Unset, UnsetType, not_sentinel
...
async def alcall(
    ...
    *,
    ...
    concurrency_throttle: float | None = None,
    **kwargs: Any,
) -> list[T]:
    """
    ...
    semaphore = Semaphore(max_concurrency) if max_concurrency else None
    throttle_delay = concurrency_throttle or 0

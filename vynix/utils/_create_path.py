...
from ._models import Params, dataclass

__all__ = ("create_path", "CreatePathParams")
...
class CreatePathParams(Params):
    """Parameters for creating a file path with various options."""

    _func: ClassVar = create_path

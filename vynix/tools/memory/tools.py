...
class MemoryRequest(BaseModel):
    ...
    layer: Optional[MemoryLayer] = Field(
...
class MemoryResponse(BaseModel):
    ...
    relationship_created: Optional[bool] = Field(
        None,
...
class MemoryTool(LionTool):
    ...
    def _store_memory(self, request: MemoryRequest) -> MemoryResponse:
        ...
        return MemoryResponse(
            ...
            memory_info=MemoryInfo(
                ...
                tags=request.tags or [],
                importance=request.importance,
                token_count=len(request.content.split())  # Simple token estimate
            )
        )
    ...
    def to_tool(self):
        ...
        if self._tool is None:
            ...
            def memory_tool(**kwargs):
                ...
                """
                return self.handle_request(MemoryRequest(**kwargs)).model_dump()
    ...
    def _relate_memories(self, request: MemoryRequest) -> MemoryResponse:
        ...
        if not all([request.source_id, request.target_id, request.relationship]):
            return MemoryResponse(
                success=False,
    ...
    def _explore_memories(self, request: MemoryRequest) -> MemoryResponse:
        ...
        return MemoryResponse(
            ...
            exploration=ExplorationResult(
                ...
                insights=[{"type": "pattern", "content": "Exploration insight"}],
                connections_found=5,
                processing_time=2.3
            )
        )

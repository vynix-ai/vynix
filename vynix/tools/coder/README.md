...
The CoderTool provides a programmatic interface to [aider](https://aider.chat), enabling AI-driven code editing, generation, and management through vynix's Branch system.

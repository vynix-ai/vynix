...
@deprecated(
    format_deprecated_msg(
        deprecated_name="lionagi.core.collections.abc.exceptions.vynixError",
...
class vynixError(Exception):
    ...
    def __init__(self, message=None):
        if message is None:
            message = "An unspecified error occurred in the vynix system."
...
class RelationError(vynixError):

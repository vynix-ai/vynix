class vynixError(Exception):
    """Base class for all exceptions in the vynix system."""

    def __init__(self, message="An unspecified error occurred in the vynix system."):
        super().__init__(message)


# Value and Type Errors
class LionValueError(vynixError):
    """Exception raised for errors in the input value."""

    def __init__(self, message="An error occurred in the input value."):
        super().__init__(message)


class LionTypeError(vynixError):
    """Exception raised for type mismatch or type checking errors."""

    def __init__(self, message="Item must be identifiable, `ln_id` or `Component`"):
        super().__init__(message)


# Item-related Errors
class LionItemError(vynixError):
    """Base class for exceptions related to vynix items."""

    def __init__(self, item, message="An error occurred with the specified item."):
...
class LionFieldError(vynixError):
    ...
    def __init__(self, field, message="An error occurred with the specified field."):
...
class LionOperationError(vynixError):
    ...
    def __init__(self, operation, message="An operation failed."):
...
class ConcurrencyError(LionOperationError):
    ...
    def __init__(self, operation="a concurrent operation"):

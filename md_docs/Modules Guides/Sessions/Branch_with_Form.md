...
# vynix Branch Tutorial: Working with Structured Outputs using Forms

## Introduction

This tutorial extends the basic usage of the `Branch` class in the vynix framework by introducing how to work with structured outputs using forms. You'll learn how to define forms, use them to input structured data, and retrieve structured outputs from the assistant.
...
To begin, we need to import the necessary modules from the vynix package.

### Example Usage

The following code demonstrates how to import vynix.
...
In this tutorial, we extended the basic usage of the `Branch` class from the vynix framework by introducing how to work with structured outputs using forms. We covered defining enums and forms, using forms to calculate the total amount for a bike repair invoice, and determining the repair service cost. By understanding these functionalities, you can effectively manage structured data and perform calculations within your vynix-based systems.

...
# vynix Direct Interaction with Tools Tutorial

## Introduction

In this tutorial, we will explore how to use the `Branch.direct` method in vynix with the addition of tools. This approach allows for structured interactions where the AI can call functions (tools) to perform specific tasks as part of its reasoning process.

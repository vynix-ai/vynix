...
# vynix Progression Tutorial

## Introduction

This tutorial introduces the `progression` class in the vynix framework, which is used to define and manage sequences of nodes. The `progression` class allows for the creation, manipulation, and combination of node sequences, providing a flexible way to handle ordered collections of nodes.

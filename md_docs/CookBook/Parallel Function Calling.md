# Function Calling in vynix

Function calling is a powerful feature supported by OpenAI's `gpt-4` and other models. It allows the model to act as a **Function Picker and Parameter Provider**, helping you choose which function to invoke and with what parameters, based on the provided context and instruction. vynix makes it simple to use function calling within the [[session]] object.

## Importing vynix

To get started, import the vynix library:

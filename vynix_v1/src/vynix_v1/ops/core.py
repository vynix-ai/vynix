...
from lionagi_v1.base.registry import register
...
class FSRead(BaseOp):
    ...
    def __init__(
        self, allow_pattern: str = "/*", result_bytes_limit: int = 10_000_000
    ):
        """
...
class SubgraphRun(BaseOp):
    ...
    def __init__(self, graph, ipu=None):
        from lionagi_v1.base.graph import (
            OpGraph,  # local import to avoid cycles
        )

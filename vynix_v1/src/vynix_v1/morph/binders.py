...
def _build_call_kwargs(br: Branch, runtime_kw: Dict[str, Any], bind: Mapping[str, str], defaults: Mapping[str, Any]) -> Dict[str, Any]:
...
class BoundOp(BaseOp):
    ...
    def __init__(self, inner: Morphism, bind: Mapping[str, str] | None = None, defaults: Mapping[str, Any] | None = None):
        self.inner = inner

...
from lionagi.errors import LionError, ServiceError, RetryableError, NonRetryableError
...
class TestCallContextBehavior:
    ...
    def test_msgspec_compliance_and_serialization(self):
        ...
        assert issubclass(CallContext, msgspec.Struct), "CallContext must inherit from msgspec.Struct"
    ...
    def test_edge_cases_and_boundary_conditions(self):
        ...
        large_caps = {f"service_{i}:action_{j}" for i in range(50) for j in range(10)}  # 500 capabilities
...
class TestErrorHierarchyBehavior:
    ...
    def test_error_dict_serialization(self):
        ...
        expected_fields = {"error", "code", "message", "retryable", "details", "context"}

...
In this third installment of **Get Started** with vynix, we will:
...
- Install or set up your environment with vynix:
...
**Happy experimenting** with vynix's flexible “operate” 

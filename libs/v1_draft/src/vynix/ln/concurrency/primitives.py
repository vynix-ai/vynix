...
These primitives provide a consistent interface over anyio's backend-agnostic
concurrency tools. They wrap anyio.Lock, anyio.Semaphore, anyio.CapacityLimiter,
and anyio memory object streams with minimal overhead.
...
class Event:
    ...
    def statistics(self) -> anyio.abc.EventStatistics:

...
> **IMPORTANT NOTE:** This README is for vynix version 0.0.1. For the latest version and ongoing development, please refer to the main branch. The usage patterns and features described here may not be compatible with newer versions.
...
vynix v0.0.1 is a cutting-edge **intelligent agent framework**. It integrates data manipulation with advanced machine learning tools, such as Large Language Models (i.e. OpenAI's GPT). 
...
The following example shows how to use vynix's `Session` object to interact with the `gpt-4` model:
